...
const FilterSidebar = () => {
  ...
  const materials = ["Cotton", "Wool", "Denim", "Polyster", "Silk", "Linen"];
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            <button
              ...
              className={`w-8 h-8 border border-gray-300 rounded-full cursor-pointer transition-colors  hover:scale-105 ${
